...
int main(int argc, char *argv[])
{
    ...
    tracer.settings = {
        ...
        .isStratifiedSampling =  settings.value("Settings/isStratifiedSampling").toBool(),
        .isLowDiscrepancySampling =  settings.value("Settings/isLowDiscrepancySampling").toBool(),
        .isImportance =  settings.value("Settings/isImportanceSampling").toBool(),
        .isAttenuate =  settings.value("Settings/isAttenuate").toBool(),
    };
